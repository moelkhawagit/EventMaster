...
public class RegistrationSceneController implements Initializable {
    ...
    public void registerBtn(ActionEvent event) throws IOException{
        ...
        else if(username.contains(" ") || password.contains(" ") || firstName.contains(" ") || lastName.contains(" ") || email.contains(" ") || phone.contains(" "))
            new Alert(Alert.AlertType.ERROR, "PLEASE NO SPACES IN ANY ENTERED DATA!").showAndWait();
        else{                
